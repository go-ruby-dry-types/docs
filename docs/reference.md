...
The public API lives at the module root (`github.com/go-ruby-dry-types/dry-types`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `dry-types`, while the surface follows
...
```go
import "github.com/go-ruby-dry-types/dry-types"
```
...
- **[pkg.go.dev/github.com/go-ruby-dry-types/dry-types](https://pkg.go.dev/github.com/go-ruby-dry-types/dry-types)**

The module's [README](https://github.com/go-ruby-dry-types/dry-types#readme) carries worked
