...
`go-ruby-dry-types/dry-types` reimplements Ruby's `dry-types` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-dry-types/dry-types` directly, with no Ruby runtime;
